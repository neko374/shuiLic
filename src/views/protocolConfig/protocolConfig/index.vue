<template>
  <div class="app-container">
    ...
    <yxdialog v-if="dialogStatus==='yx'" v-model="yxdialogInfo" :abc.sync="dialogFormVisible" text="yx" />
...
import yxdialog from './compoenents/dialogyx'
