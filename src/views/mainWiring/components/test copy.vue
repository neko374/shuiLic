<template>
  ...
  <svg viewBox="0 0 1100 480" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <svg width="1000" height="480"
    ...
    <g id="htmlx">
        <text x="0" y="0" fill="black" style="font-size:16px;" id="htmlFont">
            ...
            <tspan x="377" y="53" id="font636998685775996800" type="fontTag" fill="black" tagnames="75T1" style="font-size:12px;">75T1</tspan>
            <tspan x="714" y="48" id="font186544168775267600" type="fontTag" fill="black" tagnames="98T1" style="font-size:12px;">98T1</tspan>
            <tspan x="875" y="48" id="font29794996349438610" type="fontTag" fill="black" tagnames="2T1" style="font-size:12px;">2T1</tspan>
            ...
            <tspan x="570" y="342" id="font82759218000296740" type="fontTag" fill="black" tagnames="124" style="font-size:12px;"><tspan fill="blue">{{curName[5].value | numFilter}}</tspan> %</tspan>
        ...
        <defs>
            <marker id="TriangleA" viewBox="0 0 20 20" refX="166.456" refY="10" markerWidth="5" markerHeight="5" orient="auto">
        ...
        <line x1="135" x2="135" y1="61" y2="911" id="line873630535190127900" type="line" stroke="rgba(13, 12, 12, 1)" stroke-width="5" fill="none" tagnames="母线1" transform="rotate(270 135 61)" y="-65" x="7"></line>
        <line x1="131" x2="131" y1="174" y2="334" id="line400162785629756300" type="line" stroke="rgba(17, 16, 16, 1)" stroke-width="5" fill="none" tagnames="母线2" transform="rotate(270 131 174)"></line>
        ...
        <line x1="290" x2="290" y1="63" y2="171" id="line540468464761158400" type="line" stroke="black" stroke-width="2" fill="none" tagnames="母线联络线1" transform="rotate(0 290 63)"></line>
        <line x1="444" x2="444" y1="64" y2="134" id="line807919303108113800" type="line" stroke="rgba(13, 12, 12, 1)" stroke-width="2" fill="none" tagnames="箭头线1" transform="rotate(0 444 64)" marker-end="url(#Triangle)"></line>
        <line x1="561" x2="561" y1="64" y2="194" id="line291253573261790460" type="line" stroke="black" stroke-width="2" fill="none" tagnames="升压变线1" transform="rotate(0 561 64)"></line>
        <line x1="563" x2="563" y1="237" y2="270" id="line280293674959956930" type="line" stroke="black" stroke-width="2" fill="none" tagnames="升压变线2" transform="rotate(0 563 237)"></line>
        <line x1="665" x2="665" y1="62" y2="132" id="line905318965459109100" type="line" stroke="black" stroke-width="2" fill="none" tagnames="箭头线2" transform="rotate(0 665 62)" marker-end="url(#Triangle)"></line>
        <line x1="806" x2="806" y1="63" y2="133" id="line587155248177097600" type="line" stroke="black" stroke-width="2" fill="none" tagnames="箭头线3" transform="rotate(0 806 63)" marker-end="url(#Triangle)"></line>
        <line x1="947" x2="947" y1="63" y2="133" id="line92355894931980930" type="line" stroke="rgba(14, 13, 13, 1)" stroke-width="2" fill="none" tagnames="箭头线4" transform="rotate(0 947 63)" marker-end="url(#Triangle)"></line>
        ...
        <line x1="563" x2="563" y1="276" y2="396" id="line530950716527041700" type="line" stroke="black" stroke-width="2" fill="none" tagnames="储能线1" transform="rotate(0 563 276)"></line>
        <svg class="icon" type="wp" id="svg221400506221600000" tagnames="开关1" aria-hidden="true" width="32" x="274" y="-128">
            <use xlink:href="#icon-juxing1" color="red"></use>
        </svg>
        <svg class="icon" type="wp" id="svg582741399497558800" tagnames="开关2" aria-hidden="true" width="32" x="545" y="-127">
            <use xlink:href="#icon-juxing1" color="#0088D2"></use>
        </svg>
        <svg class="icon" type="wp" id="svg379993653281724100" tagnames="开关3" aria-hidden="true" width="32" x="451" y="79">
            <use xlink:href="#icon-juxing1" color="#0088D2"></use>
        </svg>
        <svg class="icon" type="wp" id="svg10720010307011530" tagnames="开关4" aria-hidden="true" width="32" x="547" y="79">
            <use xlink:href="#icon-juxing1" color="#0088D2"></use>
        </svg>
        <svg class="icon" type="wp" id="svg545293439357240200" tagnames="开关5" aria-hidden="true" width="32" x="639" y="76">
            <use xlink:href="#icon-juxing1" color="#0088D2"></use>
        </svg>
