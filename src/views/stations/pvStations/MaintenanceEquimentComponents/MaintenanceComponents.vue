<template>
  <div style="width:100%;height:100%;">
    ...
    >
      ...
      <el-table-column prop="name" label="组件名称" min-width="100" show-overflow-tooltip />
      <el-table-column prop="componentInfoEntity.snId" label="组件ID" min-width="100" show-overflow-tooltip />
      <el-table-column prop="pid" label="所属逆变器名称" min-width="120" show-overflow-tooltip>
      ...
      <el-table-column prop="componentInfoEntity.pv" label="单片功率" min-width="130" show-overflow-tooltip />
    ...
    <el-dialog v-if="dialogStatus==='create'||dialogStatus==='update'" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" custom-class="user-management-diaCr">
      <el-form ref="dataForm" status-icon :rules="rules" :model="temp[dialogStatus]" size="mini" label-position="left" label-width="160px">
        ...
        <el-form-item label="组件ID" prop="snId">
          <el-input v-model="temp[dialogStatus].componentInfoEntity.snId" />
        </el-form-item>
        <el-form-item label="所属逆变器" prop="pid">
          <el-select v-model="temp[dialogStatus].pid" placeholder="所属逆变器">
            <el-option
        ...
        <!-- <el-form-item label="装机容量(kWp)" prop="rated">
